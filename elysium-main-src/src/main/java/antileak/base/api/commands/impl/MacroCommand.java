    ...
    public void execute(LiteralArgumentBuilder<CommandSource> builder) {
        builder
                                ...
                                .then(arg("bind", word())
                                        ...
                                        .then(arg("command", greedyString())
                                                .executes(context -> {
                                                    ...
                                                    if (elysium.INSTANCE.macroStorage.getMacro(name) != null) {
                                                    ...
                                                    try {
                                                        ...
                                                        elysium.INSTANCE.macroStorage.add(new Macro(
                                                                name,
                                                                command,
                ...
                .then(literal("remove")
                        .then(arg("name", word())
                                .suggests((context, builder1) -> {
                                    elysium.INSTANCE.macroStorage.getNames().stream()
                                ...
                                .executes(context -> {
                                    String name = context.getArgument("name", String.class);
                                    if (elysium.INSTANCE.macroStorage.isEmpty()) {
                                        ChatUtils.sendMessage("Список макросов пуст!");
                                        return SINGLE_SUCCESS;
                                    }

                                    Macro macro = elysium.INSTANCE.macroStorage.getMacro(name);
                                    if (macro == null) {
                                        ChatUtils.sendMessage("Макрос " + name + " не найден!");
                                        return SINGLE_SUCCESS;
                                    }

                                    elysium.INSTANCE.macroStorage.remove(macro);
                ...
                .then(literal("list")
                        .executes(context -> {
                            ...
                            if (elysium.INSTANCE.macroStorage.getNames().isEmpty()) {
                                ChatUtils.sendMessage("Список макросов пуст!");
                            } else {
                                for (int i = 0; i < elysium.INSTANCE.macroStorage.getNames().size(); i++) {
                                    builder1.append(elysium.INSTANCE.macroStorage.getNames().get(i));
                                    if (i < elysium.INSTANCE.macroStorage.getNames().size() - 1) {
                                        builder1.append(", ");
                                    }
                                }
                                builder1.append(".");
                ...
                .then(literal("clear")
                        .executes(context -> {
                            if (!elysium.INSTANCE.macroStorage.isEmpty()) {
                                elysium.INSTANCE.macroStorage.clear();
