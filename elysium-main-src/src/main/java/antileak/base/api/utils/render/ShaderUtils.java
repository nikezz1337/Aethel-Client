package antileak.base.api.utils.render;
...
public class ShaderUtils implements QClient {
    ...
    public final ShaderProgramKey worldShader = register("worldshader", "world_shader", VertexFormats.POSITION_TEXTURE_COLOR);
    public final ShaderProgramKey customSkySummer = register("skyshader", "sky_summer", VertexFormats.POSITION);
    public final ShaderProgramKey customSkyWater = register("skyshader", "sky_water", VertexFormats.POSITION);
    public final ShaderProgramKey customSkyOcean = register("skyshader", "sky_ocean", VertexFormats.POSITION);
    public final ShaderProgramKey customSkyCaustic = register("skyshader", "caustic", VertexFormats.POSITION);
    public final ShaderProgramKey customSkyPlasma = register("skyshader", "sky_plasma", VertexFormats.POSITION);
    public final ShaderProgramKey customSkyShader = register("skyshader", "sky_shader", VertexFormats.POSITION);
    ...
    private ShaderProgramKey register(String shaderNamePackage, String shaderName, VertexFormat vertexFormat) {
        return new ShaderProgramKey(Identifier.of("elysium", "core/" + shaderNamePackage + "/" + shaderName), vertexFormat, Defines.EMPTY);
    }
}
