...
import antileak.base.api.utils.render.glow.GlowCallback;
import antileak.base.api.utils.render.glow.GlowProgram;
...
public class RenderUtils implements QClient {
    ...
    public void drawDefaultHudElementRects(MatrixStack matrices, float x, float y, float width, float height, int themeColor, boolean drawPattern) {
        ...
        drawBlur(matrices, x, y, width, height, 4, 5, ColorUtils.rgba(0,0,0,150));
        if (drawPattern) {
    ...
    private void drawDefaultHudPanelGlass(MatrixStack matrices, float x, float y, float width, float height, float borderRadius) {
        drawBlur(matrices, x - 0.5f, y - 0.5f, width + 1.0f, height + 1.0f, 3, ColorUtils.rgba(255,255,255,255));
        drawBlur(matrices, x - 0.5f, y - 0.5f, width + 1.0f, height + 1.0f, 3, ColorUtils.rgba(0,0,0,150));
    }
