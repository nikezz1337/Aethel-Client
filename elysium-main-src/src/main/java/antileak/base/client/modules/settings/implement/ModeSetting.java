package antileak.base.client.modules.settings.implement;
...
public class ModeSetting extends Setting {
    ...
    public String displayMode(String mode) {
        return elysium.INSTANCE.localizationStorage == null ? mode : elysium.INSTANCE.localizationStorage.translate(mode);
    }
