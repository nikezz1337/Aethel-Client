...
public class AutoForest extends Module {
    ...
    private final ModeSetting breakMode = new ModeSetting("Р РµР¶РёРј Р»РѕРјР°РЅРёСЏ", "РћР±С‹С‡РЅС‹Р№", "РћР±С‹С‡РЅС‹Р№", "Р‘С‹СЃС‚СЂС‹Р№");
    private final FloatSetting packetsPerSecond = new FloatSetting("РџР°РєРµС‚РѕРІ РІ СЃРµРєСѓРЅРґСѓ", DEFAULT_PACKETS_PER_SECOND, 1.0f, 100.0f, 1.0f)
            .visible(() -> breakMode.is("Р‘С‹СЃС‚СЂС‹Р№"));
    private final FloatSetting breakRadius = new FloatSetting("Р Р°РґРёСѓСЃ", 4.0f, 1.0f, 6.0f, 0.5f);
    private final BooleanSetting swing = new BooleanSetting("РњР°С…Р°С‚СЊ СЂСѓРєРѕР№", true);
    private final BooleanSetting autoSell = new BooleanSetting("РђРІС‚Рѕ РїСЂРѕРґР°Р¶Р° РґРµСЂРµРІР°", true);
    private final BooleanSetting autoPay = new BooleanSetting("AutoPay", false);
    private final BooleanSetting preserveVisuals = new BooleanSetting("РЎРѕС…СЂР°РЅСЏС‚СЊ РІРёР·СѓР°Р»РёР·Р°С†РёСЋ", true);
    private final FloatSetting payAmount = new FloatSetting("РЎСѓРјРјР° РїРµСЂРµРІРѕРґР°", 1000.0f, 500.0f, 25000.0f, 500.0f)
            .visible(autoPay::isState);
    private final FloatSetting intervalSeconds = new FloatSetting("Р—Р°РґРµСЂР¶РєР°", 20.0f, 1.0f, 60.0f, 1.0f);
    ...
    public AutoForest() {
        super("AutoForest", "РђРІС‚РѕРјР°С‚РёС‡РµСЃРєРё Р»РѕРјР°РµС‚ Р±СЂРµРІРЅР° Рё РїРµСЂРµРІРѕРґРёС‚ РґРµРЅСЊРіРё", ModuleCategory.PLAYER);
