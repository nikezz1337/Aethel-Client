...
public class TargetESP extends Module {
    ...
    private Identifier getCaptureTexture() {
        if (mode.is("Картинка 2")) {
            return Identifier.of("elysium", "textures/targetesp/targetesp_3.png");
        }
        return Identifier.of("elysium", "textures/targetesp/targetesp_2.png");
    }

    private Identifier getBloomTexture() {
        return Identifier.of("elysium", "textures/targetesp/bloom.png");
    }
