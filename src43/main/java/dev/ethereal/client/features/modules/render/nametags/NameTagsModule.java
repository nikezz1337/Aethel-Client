...
public class NameTagsModule extends Module {
    ...
    public final BooleanSetting debugProfiler = new BooleanSetting("Debug profiler").value(false);
    ...
    public NameTagsModule() {
        addSettings(targets, information, options, box3d, boxAlpha, debugProfiler);
    }
