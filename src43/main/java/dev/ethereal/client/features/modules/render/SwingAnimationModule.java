...
public class SwingAnimationModule extends Module {
    ...
    public final ModeSetting mode = new ModeSetting("Mode").value("Default").values(
            "Default", "Swing", "Swing Down", "Side Down", "Rotate", "Weird", "Pulse",
            "Mode 1", "Mode 2", "Mode 3", "Mode 4", "Mode 5"
    );
    private final BooleanSetting auraOnly = new BooleanSetting("Only with aura").value(false);
    public final SliderSetting strength = new SliderSetting("Strength").value(20f).range(1f,75f).step(0.1f).setVisible(() ->
            !mode.is("Default") && !mode.is("Rotate") && !mode.is("Mode 1") && !mode.is("Mode 5"));
    ...
    private void handleSwordAnim(MatrixStack matrices, float swingProgress, Arm arm) {
        ...
        switch (mode.getValue()) {
            ...
            case "Swing" -> {
                matrices.translate(isLeft * 0.67F, -0.32F, -1F);
                matrices.multiply(RotationAxis.POSITIVE_Y.rotationDegrees(90f));
                matrices.multiply(RotationAxis.POSITIVE_Z.rotationDegrees(-60f));
                matrices.multiply(RotationAxis.POSITIVE_X.rotationDegrees(-90f - strength.getValue() * anim));
            }
            case "Swing Down" -> {
                matrices.translate(isLeft * 0.67F, -0.32F, -1F);
                matrices.multiply(RotationAxis.POSITIVE_Y.rotationDegrees(80f));
                matrices.multiply(RotationAxis.POSITIVE_Z.rotationDegrees(-30f));
                matrices.multiply(RotationAxis.POSITIVE_X.rotationDegrees(-100f - strength.getValue() * anim));
            }
            case "Side Down" -> {
                matrices.translate(isLeft * 0.67F, -0.32F, -1F);
                matrices.translate(anim * -strength.getValue() / 35f, 0f, anim * -strength.getValue() / 35f);
                matrices.multiply(RotationAxis.POSITIVE_Y.rotationDegrees(25f));
                matrices.multiply(RotationAxis.NEGATIVE_X.rotationDegrees(anim * strength.getValue() * 5f));
            ...
            case "Pulse" -> {
                matrices.translate(isLeft * 0.56F, -0.52F, -0.72F);
                matrices.multiply(RotationAxis.POSITIVE_X.rotationDegrees(anim * -strength.getValue() * 2f));
                matrices.multiply(RotationAxis.POSITIVE_Y.rotationDegrees(anim * strength.getValue() * isLeft));
                matrices.multiply(RotationAxis.POSITIVE_Z.rotationDegrees(anim * strength.getValue()));
            }
            case "Rotate" -> {
                matrices.translate(isLeft * 0.56F, -0.52F, -0.72F);
            ...
            case "Weird" -> {
                matrices.translate(isLeft * 0.56F, -0.32F, -0.72F);
                matrices.translate(0f, 0f, -1.5f * anim / 5.0f);
                matrices.multiply(RotationAxis.POSITIVE_Y.rotationDegrees(80f));
                matrices.multiply(RotationAxis.NEGATIVE_Z.rotationDegrees(45f));
                matrices.multiply(RotationAxis.POSITIVE_Y.rotationDegrees(-10f));
                matrices.translate(0f, 0f, -0.4f * anim);
                matrices.multiply(RotationAxis.NEGATIVE_X.rotationDegrees(anim * -100f));
                matrices.multiply(RotationAxis.POSITIVE_X.rotationDegrees(anim * -180f));
