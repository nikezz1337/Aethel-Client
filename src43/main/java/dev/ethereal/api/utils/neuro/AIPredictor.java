package dev.ethereal.api.utils.neuro;
...
import dev.ethereal.api.utils.animation.wrap.infinity.RotationAnimation;
...
//        float targetPitch = predictedPitch + pitchDiff - interpolation.getPitch();
        ...
        if (mc.player.isSwimming()) {
            ...
            speed = new Vector2f(MathUtil.random(200, 350), MathUtil.random(200, 350));
        }
