            ...
            if (slotFirstItem == 40 || slotFirstItem == -1 && slotSecondItem != 40) {
                if (slotSecondItem >= 0 && slotSecondItem <= 8) {
                    ...
                    switch (mode.getValue()) {
                        ...
                        case "Polar" -> InventoryUtil.swapBypass(() -> mc.interactionManager.clickSlot(0, 45, finalSlotSecondItem, SlotActionType.SWAP, mc.player));
                        case "ReallyWorld" -> {
                            if (mc.player.isOnGround()) InventoryUtil.swapBypass(() -> mc.interactionManager.clickSlot(0, 45, finalSlotSecondItem, SlotActionType.SWAP, mc.player));
                    ...
                    switch (mode.getValue()) {
                        ...
                        case "Polar" -> InventoryUtil.swapBypass(() -> mc.interactionManager.clickSlot(0, finalSlotSecondItem, 40, SlotActionType.SWAP, mc.player));
                        case "ReallyWorld" -> {
                            if (mc.player.isOnGround()) InventoryUtil.swapBypass(() -> mc.interactionManager.clickSlot(0, finalSlotSecondItem, 40, SlotActionType.SWAP, mc.player));
                ...
                if (slotFirstItem >= 0 && slotFirstItem <= 8) {
                    switch (mode.getValue()) {
                        ...
                        case "Polar" -> InventoryUtil.swapBypass(() -> mc.interactionManager.clickSlot(0, 45, slotFirstItem, SlotActionType.SWAP, mc.player));
                        case "ReallyWorld" -> {
                            if (mc.player.isOnGround()) InventoryUtil.swapBypass(() -> mc.interactionManager.clickSlot(0, 45, slotFirstItem, SlotActionType.SWAP, mc.player));
                    ...
                    switch (mode.getValue()) {
                        ...
                        case "Polar" -> InventoryUtil.swapBypass(() -> mc.interactionManager.clickSlot(0, slotFirstItem, 40, SlotActionType.SWAP, mc.player));
                        case "ReallyWorld" -> {
                            if (mc.player.isOnGround()) InventoryUtil.swapBypass(() -> mc.interactionManager.clickSlot(0, slotFirstItem, 40, SlotActionType.SWAP, mc.player));
