    ...
    public void onPacket(EventPacket e) {
        ...
        if (e.getPacket() instanceof ClickSlotC2SPacket click && mc.currentScreen instanceof InventoryScreen) {
            ...
            SlownessManager.addTask(new SlownessManager.SlowTask(60, 0, () -> {
                ...
                if ((click.getActionType() == SlotActionType.SWAP && click.getSlot() != 1 && click.getSlot() != 2 && click.getSlot() != 3 && click.getSlot() != 4) || click.getActionType() == SlotActionType.QUICK_MOVE) NetworkUtils.sendSilentPacket(new CloseHandledScreenC2SPacket(0));
            }));
            e.cancelEvent();
        }
