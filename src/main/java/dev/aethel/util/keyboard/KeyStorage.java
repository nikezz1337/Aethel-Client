package dev.aethel.util.keyboard;
...
public class KeyStorage implements IMinecraft {
    ...
    public static boolean isPressed(int keyCode) {
        ...
        // Отрицательные коды (-100 + button) — новый формат
        ...
        // Сырые коды мыши (0 … GLFW_MOUSE_BUTTON_LAST) — для обратной совместимости
        if (keyCode >= 0 && keyCode <= GLFW.GLFW_MOUSE_BUTTON_LAST) {
    ...
    private static void reverseMappings() {
        ...
        // Добавляем отрицательные коды для мышиных кнопок (нужны для BindSetting)
        reverseKeyMap.put(-100 + 0, "MOUSE1");
        reverseKeyMap.put(-100 + 1, "MOUSE2");
        reverseKeyMap.put(-100 + 2, "MOUSE3");
        reverseKeyMap.put(-100 + 3, "MOUSE4");
        reverseKeyMap.put(-100 + 4, "MOUSE5");
    }
}
