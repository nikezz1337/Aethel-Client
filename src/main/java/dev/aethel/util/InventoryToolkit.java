...
import dev.aethel.mixin.ClientPlayerInteractionManagerAccessor;
...
import dev.aethel.util.inventory.InventoryResult;
...
public final class InventoryToolkit implements IMinecraft {
    ...
    public static void switchTo(int slot) {
        ...
        if (lastSentSlot == -1) {
            lastSentSlot = mc.player.getInventory().selectedSlot;
        }
        if (mc.player.getInventory().selectedSlot != lastSentSlot) {
            lastSentSlot = mc.player.getInventory().selectedSlot;
        }
    ...
    public static void switchToLocal(int slot) {
