...
import dev.aethel.util.parse.ParseTextUtil;
...
public final class MsdfFont {
	...
	public static class Builder {
		...
		public Builder data(String dataFileName) {
			this.dataIdentifer = Identifier.of("aethel", "fonts/" + dataFileName + ".json");
			return this;
		}

		public Builder atlas(String atlasFileName) {
			this.atlasIdentifier = Identifier.of("aethel", "fonts/" + atlasFileName + ".png");
			return this;
		}
