...
public class ModeListComponent extends Component {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        if (openAnim.getValue() > 0.01f) {
            ...
            for (BooleanSetting mode : setting.getSettings()) {
                ...
                DrawUtil.drawText(Fonts.SFSEMIBOLD.get(), mode.getName(), x + 7, currentY + 2f, ColorProvider.setAlpha(textColor, (int)(255 * alpha * openAnim.getValue())), 6.5f);
