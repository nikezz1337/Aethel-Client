...
package ru.zenith.implement.features.commands.argument;

import ru.zenith.api.feature.command.argument.IArgConsumer;
import ru.zenith.api.feature.command.argument.ICommandArgument;
import ru.zenith.api.feature.command.datatypes.IDatatype;
import ru.zenith.api.feature.command.datatypes.IDatatypeContext;
import ru.zenith.api.feature.command.datatypes.IDatatypeFor;
import ru.zenith.api.feature.command.datatypes.IDatatypePost;
import ru.zenith.api.feature.command.exception.CommandException;
import ru.zenith.api.feature.command.exception.CommandInvalidTypeException;
import ru.zenith.api.feature.command.exception.CommandNotEnoughArgumentsException;
import ru.zenith.api.feature.command.exception.CommandTooManyArgumentsException;
import ru.zenith.api.feature.command.manager.ICommandManager;
