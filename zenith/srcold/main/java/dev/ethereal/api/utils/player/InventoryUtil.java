...
public class InventoryUtil implements QuickImports {
    ...
    public static class ItemUsage {
        ...
        private static long getDelay() {
            return PlayerUtil.isST() ? 70L : PlayerUtil.isRW() ? 90L : PlayerUtil.isFT() ? 60L : 30L;
        }
        ...
        public void applyRotation() {
            ...
            RotationStrategy configurable = new RotationStrategy(new SmoothRotation(), AuraModule.getInstance().moveCorrection.getValue());
        ...
        public void executeLegitMode(int bind) {
            switch (usageState) {
                case IDLE:
                    ...
                    targetSlot = InventoryUtil.findItem(item);
                ...
                case MOVE_TO_OFFHAND:
                    ...
                    if (SlownessManager.isEnabled()) {
                        SlownessManager.applySlowness(getDelay(), moveToOffhand);
                    } else {
                        moveToOffhand.run();
                    }
                    break;
                ...
                case RESTORE_OFFHAND:
                    ...
                    if (SlownessManager.isEnabled()) {
                        SlownessManager.applySlowness(getDelay(), restoreOffhand);
                    } else {
                        restoreOffhand.run();
                    }
                    break;
