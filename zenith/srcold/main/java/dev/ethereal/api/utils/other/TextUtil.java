...
import dev.ethereal.api.utils.render.fonts.MsdfGlyph;
...
public class TextUtil implements QuickImports {
    ...
    public void sendMessage(String message) {
        mc.player.sendMessage(Text.literal("").append(gradient("Quality", true)).append(Text.literal(Formatting.GRAY + " >> " + Formatting.RESET + message)), false);
    }
