...
public class RectRender {
    ...
    public void drawBorder(MatrixStack matrixStack, float x, float y, float width, float height, float radius, float borderWidth, Color color) {
        draw(matrixStack, x - borderWidth, y - borderWidth, width + borderWidth * 2, height + borderWidth * 2,
            radius + borderWidth, color);
    }
