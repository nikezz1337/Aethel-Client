...
import dev.ethereal.api.utils.auction.nbt.NbtUtils;
...
@UtilityClass
public class ABItems implements QuickImports {
    private final File ITEMS_DIR = new File(ClientInfo.CONFIG_PATH_OTHER, "autobuy-items");
