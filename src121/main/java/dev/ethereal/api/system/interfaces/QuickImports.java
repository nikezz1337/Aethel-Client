...
public interface QuickImports {
    ...
    default void print(String message, boolean overlay) {
        TextUtil.sendMessage(message, overlay);
    }

    default void print(Float message) {
        TextUtil.sendMessage(String.valueOf(message));
    }
