...
public class BooleanComponent extends SettingComponent {
    ...
    public BooleanComponent(BooleanSetting setting, boolean inMenu) {
        ...
        toggleAnimation.setValue(setting.getValue() != null && setting.getValue() ? 1.0 : 0.0);
        this.inMenu = inMenu;
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        toggleAnimation.run(setting.getValue() != null && setting.getValue() ? 1.0 : 0.0, 150, Easing.EXPO_OUT);
